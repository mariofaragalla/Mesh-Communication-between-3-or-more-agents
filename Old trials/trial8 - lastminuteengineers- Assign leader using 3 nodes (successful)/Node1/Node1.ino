...
void isLeader(){  // this funciton is to decide if this node is the leader or not (decided by the server)
  ...
  radio.stopListening(); 
  if(leaderData.address == my_id){          //if they are equal then this node is the leader
